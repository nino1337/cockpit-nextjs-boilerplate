<script>
  ...
  window.__lokalizeProjects = <?php echo  json_encode($projects) ; ?>

</script>

<div>
    <ul class="uk-breadcrumb">
        <li class="uk-active"><span><?php echo $app("i18n")->get('Lokalize'); ?></span></li>
    </ul>
</div>
...
<div riot-view>
    ...
    <div class="uk-margin uk-clearfix" if="{ App.Utils.count(projects) }">
        ...
        <div class="uk-form-icon uk-form uk-text-muted">
            ...
            <input class="uk-form-large uk-form-blank" type="text" ref="txtfilter" placeholder="<?php echo $app("i18n")->get('Filter projects...'); ?>" onkeyup="{ updatefilter }">

        </div>

        <?php if ($app->module("cockpit")->hasaccess('lokalize', 'projects_create')) { ?>
        <div class="uk-float-right">
            <a class="uk-button uk-button-large uk-button-primary uk-width-1-1" href="<?php $app->route('/lokalize/_project'); ?>"><?php echo $app("i18n")->get('Add Project'); ?></a>
        </div>
        <?php } ?>
    ...
    <div class="uk-width-medium-1-1 uk-viewport-height-1-3 uk-container-center uk-text-center uk-flex uk-flex-middle uk-flex-center" if="{ !App.Utils.count(projects) }">
        ...
        <div class="uk-animation-scale">
            ...
            <p>
                <img class="uk-svg-adjust uk-text-muted" src="<?php echo $app->pathToUrl('lokalize:icon.svg'); ?>" width="80" height="80" alt="Collections" data-uk-svg />
            </p>
            <hr>
            <span class="uk-text-large"><strong><?php echo $app("i18n")->get('No Projects'); ?>.</strong>
            <?php if ($app->module("cockpit")->hasaccess('lokalize', 'projects_create')) { ?>
            <a href="<?php $app->route('/lokalize/_project'); ?>"><?php echo $app("i18n")->get('Create one'); ?></a></span>
            <?php } ?>
        </div>
            ...
            <div class="uk-grid uk-grid-match uk-margin" data-uk-grid-margin>
                ...
                <div class="uk-flex-item-1">
                    <div class="uk-grid">
                        <div class="uk-width-1-5">
                            <div class="uk-text-small uk-text-uppercase uk-text-muted"><?php echo $app("i18n")->get('Done'); ?></div>
                            <div class="uk-margin-small-top uk-h2">{ _.get(project, 'done._all') || 0 }%</div>
                        </div>
                        <div class="uk-width-1-5">
                            <div class="uk-text-small uk-text-uppercase uk-text-muted"><?php echo $app("i18n")->get('Keys'); ?></div>
                            <div class="uk-margin-small-top uk-h2">{App.Utils.count(project.keys)}</div>
                        </div>
                        <div>
                            <div class="uk-text-small uk-text-uppercase uk-text-muted"><?php echo $app("i18n")->get('Languages'); ?></div>
                ...
                <div>
                    <div class="uk-flex uk-flex-middle">
                        ...
                        <?php if ($app->module("cockpit")->hasaccess('lokalize', 'projects_delete')) { ?>
