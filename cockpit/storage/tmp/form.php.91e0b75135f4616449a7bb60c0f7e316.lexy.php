...
<div riot-view>
        ...
        <div class="uk-container uk-container-center">
            <ul class="uk-breadcrumb">
                ...
                <li class="uk-active" data-uk-dropdown>
                    ...
                    <a><i class="uk-icon-bars"></i> <?php echo  htmlspecialchars(@$singleton['label'] ? $singleton['label']:$singleton['name'], ENT_QUOTES, 'UTF-8') ; ?></a>
    ...
    <div class="uk-margin-top">
        ...
        <div class="uk-margin uk-text-muted">
            <?php echo  htmlspecialchars($singleton['description'], ENT_QUOTES, 'UTF-8') ; ?>
        </div>
        <?php } ?>
        ...
        <div class="uk-grid">
            ...
            <div class="uk-grid-margin uk-width-medium-1-4 uk-flex-order-first uk-flex-order-last-medium">
                ...
                <div class="uk-button-group uk-flex uk-margin">
                    <a class="uk-button" onclick="{showDataObject}"><?php echo $app("i18n")->get('Show json'); ?></a>
                </div>
                <?php } ?>
